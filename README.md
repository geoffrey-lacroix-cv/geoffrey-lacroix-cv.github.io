...
Pour IT-CE : Projet Bancware, VARIO, TRADIX, Comptabase : participation aux évolutions : Analyse fonctionnelle, Rédaction des spécifications fonctionnelles, Chiffrage, Tests fonctionnels avec ALMQC, Recette MOE, Assistance MOA Pour Groupama : Dans le cadre des projets Mercure, SAP CoreModel V2, Mobilité bancaire : Analyse fonctionnelle, Rédaction des spécifications techniques, Développements et Tests Unitaires, Prise en compte des retours de recette 
Pour BPCE : Projets de maintenances et migrations bancaires du groupe Banques Populaires : analyse fonctionnelle, rédaction des spécifications techniques et détaillées, développements, tests unitaires, tests de performances et volumétrie pour les programmes de bascule, fichiers générés, à transférer. Participation préparation de bascules, bascules à blanc 
Pour CAGIP : Expert REXX : conversion Easytrieve en REXX 
Pour CATS : Participation au RUN, partie « Réalisation » GREEN (collectivités publiques, entreprises, agris pros, particuliers) 
Participation aux projets gérés via Jira, développements en Pacbase/Cobol(outils : gitlab eclipse open microfocus) 
Traitement des incidents applicatifs 
Gestion des problèmes o Développements et correction de composants Pacbase/Cobol 
...
Participation aux projets McDonough, migration des PEL/CAT, projet START, contrôles des traitements post bascule pour les Caisses d’Epargnes, TMA à chaud sur l’applicatif Client, du projet IFRS, participation aux développements de la double comptabilité (outils C++ pour dupliquer le plan de compte comptable des CE), 
Recette de la migration du progiciel RDJ V8.3.2, prise en charge du projet d’évolution OSCAR, Analyse sur projet TRADE / ALM. 
Dans le cadre de la TMA Comptabilité : maintenance corrective du système comptable sur GL Expert, RDJ, Evolan, et maintenance évolutive sur OSCAR (MsAccess) : Rédaction de spécifications détaillées, Chiffrage des évolutions et rédaction de devis, Gestion des livraisons, Développement et Tests Unitaires. Participation au projet Fusion PSI pour les Caisses d’Epargnes : développement d’un outil de suivi de bascule des caisses (ordonnanceur de pilotage de week end de bascule 2 caisses régionales / partitions-> 1 seule, outil perso pour caisse d'épargne) .

Formation 
Génie Logiciel (DUT) IUT de DIJON-Dijon (21) 2000 - 2003 
